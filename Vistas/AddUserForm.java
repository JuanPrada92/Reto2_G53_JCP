...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cédula de ciudadanía", "Cédula de extranjería", "Pasaporte", "Libreta militar" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String tipoDocumento = (String)cbTipo.getSelectedItem(); 
        String documento = txtDocument.getText();
        String email = txtEmail.getText();
        System.out.println("nombre: "+ nombre + " " + "Apellidos: " + apellidos + " " + tipoDocumento+ " "+ documento + " "+ 
                email);
